...
const translations = {
  uz: {
    ...
    "location_too_far_detailed_description": "Sizning joylashuvingiz Amur Restoranidan juda uzoqda. Masofa: {{distance}} m",
    "distance_away": "Masofa: {{distance}} m",
    "need_to_be_closer": "Siz Amur Restoraniga yaqinroq bo'lishingiz kerak.",
    "selected_location_balloon": "Tanlangan joylashuv",
    "current_location_balloon": "Joriy joylashuv",
    "loading_map": "Xarita yuklanmoqda...",
    "geolocation_not_supported_title": "Joylashuv aniqlash qo'llab-quvvatlanmaydi",
    "geolocation_not_supported_description": "Sizning brauzeringiz geolokatsiyani qo'llab-quvvatlamaydi. Iltimos, manzilni qo'lda kiriting yoki boshqa brauzerdan foydalaning.",
    "location_detected_title": "Joylashuv aniqlandi",
    "location_detected_description": "Sizning joriy joylashuvingiz muvaffaqiyatli aniqlandi.",
    "location_detection_failed_title": "Joylashuvni aniqlash muvaffaqiyatsiz",
    "location_detection_failed_description": "Joylashuvni aniqlashda xato yuz berdi. Iltimos, qayta urinib ko'ring yoki manzilni qo'lda kiriting.",
    "location_verified_title": "Joylashuv tasdiqlandi",
    "location_verified_description": "Sizning joylashuvingiz Amur Restoraniga yetarlicha yaqin.",
    "address_selected_title": "Manzil tanlandi",
    "address_selected_description": "Tanlangan manzil muvaffaqiyatli saqlandi.",
    ...
    "phone_number_readonly_tooltip": "Telefon raqami tahrirlanmaydi, chunki u profilingizga bog'langan.",
    "delivery_type_title": "Yetkazib berish turi",
    "delivery_option_delivery": "Yetkazib berish",
    "delivery_option_delivery_description": "Taomni sizning manzilingizga yetkazib beramiz.",
    "delivery_option_pickup": "O'zi olib ketish",
    "delivery_option_pickup_description": "Restorandan buyurtmani o'zingiz olib ketishingiz mumkin.",
    "delivery_option_at_restaurant": "Restoranda",
    "delivery_option_at_restaurant_description": "Restoranda stolga xizmat ko'rsatish.",
    "service_charge_note": "10% xizmat haqi qo'shiladi",
    "delivery_address_title": "Yetkazib berish manzili",
    "address_label": "Manzil",
    "address_placeholder": "Manzilingizni kiriting (masalan, Toshkent sh., Chilanzar, 45-uy)",
    "hide_map_button": "Xaritani yashirish",
    "select_from_map_button": "Xaritadan tanlash",
    "getting_location_button": "Joylashuv aniqlanmoqda...",
    "detect_location_button": "Joriy joylashuvni aniqlash",
    "select_location_on_map_label": "Xaritada joylashuvni tanlang",
    "map_instructions": "Xaritada istalgan joyni bosing yoki belgini sudrab o'tkazing",
    "selected_table_title": "Tanlangan stol",
    "selected_table_description": "Sizning buyurtmangiz ushbu stolga xizmat qiladi.",
    ...
    "special_instructions_title": "Maxsus ko'rsatmalar",
    "special_instructions_placeholder": "Maxsus ko'rsatmalar yoki talablarni kiriting (masalan, tezroq yetkazib bering)",
    "order_summary_title": "Buyurtma xulosasi",
    "food_price_label": "Taom narxi",
    "delivery_fee_label": "Yetkazib berish haqi",
    "service_charge_label": "Xizmat haqi",
    "total_label": "Jami",
    "submitting_order_button": "Buyurtma yuborilmoqda...",
    "login_to_order_button": "Buyurtma berish uchun kirish",
    "place_order_button": "Buyurtma berish",
    "order_confirmation_note": "Buyurtmangiz tasdiqlangandan so'ng tasdiq xabarini olasiz.",
    "error_occurred_title": "Xatolik yuz berdi",
    "order_creation_failed_generic_description": "Buyurtma yaratishda xato yuz berdi. Iltimos, qayta urinib ko'ring.",
    "sum": "so'm",
    "currency": "so'm",
  ...
  ru: {
    ...
    "selected_location_balloon": "Выбранное местоположение",
    "current_location_balloon": "Текущее местоположение",
    "loading_map": "Загрузка карты...",
    "geolocation_not_supported_title": "Геолокация не поддерживается",
    "geolocation_not_supported_description": "Ваш браузер не поддерживает геолокацию. Пожалуйста, введите адрес вручную или используйте другой браузер.",
    "location_detected_title": "Местоположение определено",
    "location_detected_description": "Ваше текущее местоположение успешно определено.",
    "location_detection_failed_title": "Ошибка определения местоположения",
    "location_detection_failed_description": "Не удалось определить местоположение. Пожалуйста, попробуйте снова или введите адрес вручную.",
    "location_verified_title": "Местоположение подтверждено",
    "location_verified_description": "Ваше местоположение достаточно близко к ресторану Amur.",
    "address_selected_title": "Адрес выбран",
    "address_selected_description": "Выбранный адрес успешно сохранен.",
    ...
    "phone_number_readonly_tooltip": "Номер телефона нельзя редактировать, так как он привязан к вашему профилю.",
    "delivery_type_title": "Тип доставки",
    "delivery_option_delivery": "Доставка",
    "delivery_option_delivery_description": "Мы доставим еду по вашему адресу.",
    "delivery_option_pickup": "Самовывоз",
    "delivery_option_pickup_description": "Вы можете забрать заказ из ресторана.",
    "delivery_option_at_restaurant": "В ресторане",
    "delivery_option_at_restaurant_description": "Обслуживание за столом в ресторане.",
    "service_charge_note": "Добавляется 10% за обслуживание",
    "delivery_address_title": "Адрес доставки",
    "address_label": "Адрес",
    "address_placeholder": "Введите ваш адрес (например, г. Ташкент, Чиланзар, д. 45)",
    "hide_map_button": "Скрыть карту",
    "select_from_map_button": "Выбрать на карте",
    "getting_location_button": "Определение местоположения...",
    "detect_location_button": "Определить текущее местоположение",
    "select_location_on_map_label": "Выберите местоположение на карте",
    "map_instructions": "Нажмите на любое место на карте или перетащите метку",
    "selected_table_title": "Выбранный стол",
    "selected_table_description": "Ваш заказ будет обслуживаться за этим столом.",
    "payment_method_title": "Способ оплаты",
    "payment_method_cash": "Наличные",
    "payment_method_card": "Карта",
    "payment_method_click": "Click",
    "payment_method_payme": "Payme",
    "special_instructions_title": "Особые инструкции",
    "special_instructions_placeholder": "Введите особые инструкции или требования (например, доставить быстрее)",
    "order_summary_title": "Сводка заказа",
    "food_price_label": "Стоимость блюд",
    "delivery_fee_label": "Стоимость доставки",
    "service_charge_label": "Плата за обслуживание",
    "total_label": "Итого",
    "submitting_order_button": "Отправка заказа...",
    "login_to_order_button": "Войдите, чтобы оформить заказ",
    "place_order_button": "Оформить заказ",
    "order_confirmation_note": "Вы получите подтверждение после оформления заказа.",
    "error_occurred_title": "Произошла ошибка",
    "order_creation_failed_generic_description": "Не удалось создать заказ. Пожалуйста, попробуйте снова.",
  ...
  en: {
    ...
    "selected_location_balloon": "Selected location",
    "current_location_balloon": "Current location",
    "loading_map": "Loading map...",
    "geolocation_not_supported_title": "Geolocation not supported",
    "geolocation_not_supported_description": "Your browser does not support geolocation. Please enter the address manually or use a different browser.",
    "location_detected_title": "Location detected",
    "location_detected_description": "Your current location has been successfully detected.",
    "location_detection_failed_title": "Location detection failed",
    "location_detection_failed_description": "Failed to detect location. Please try again or enter the address manually.",
    "location_verified_title": "Location verified",
    "location_verified_description": "Your location is close enough to Amur Restaurant.",
    "address_selected_title": "Address selected",
    "address_selected_description": "The selected address has been successfully saved.",
    "place_order_heading": "Place Order",
    "view_menu_button": "View Menu",
    "personal_info_title": "Personal Information",
    "full_name_label": "Full Name",
    "phone_number_label": "Phone Number",
    "phone_number_readonly_tooltip": "Phone number cannot be edited as it is tied to your profile.",
    "delivery_type_title": "Delivery Type",
    "delivery_option_delivery": "Delivery",
    "delivery_option_delivery_description": "We will deliver the food to your address.",
    "delivery_option_pickup": "Pickup",
    "delivery_option_pickup_description": "You can pick up your order from the restaurant.",
    "delivery_option_at_restaurant": "At the Restaurant",
    "delivery_option_at_restaurant_description": "Table service at the restaurant.",
    "service_charge_note": "10% service charge will be added",
    "location_verification_description": "Verify your location before placing the order. You must be within {{distance}} meters of Amur Restaurant.",
    "delivery_address_title": "Delivery Address",
    "address_label": "Address",
    "address_placeholder": "Enter your address (e.g., Tashkent city, Chilanzar, house 45)",
    "hide_map_button": "Hide Map",
    "select_from_map_button": "Select from Map",
    "getting_location_button": "Detecting location...",
    "detect_location_button": "Detect Current Location",
    "select_location_on_map_label": "Select location on map",
    "map_instructions": "Click anywhere on the map or drag the marker",
    "selected_table_title": "Selected Table",
    "selected_table_description": "Your order will be served at this table.",
    ...
    "special_instructions_placeholder": "Enter any special instructions or requests (e.g., deliver faster)",
    ...
    "login_to_order_button": "Log in to place order",
    "place_order_button": "Place Order",
    "order_confirmation_note": "You will receive a confirmation after your order is placed.",
    "error_occurred_title": "An error occurred",
    "order_creation_failed_generic_description": "Failed to create the order. Please try again.",
