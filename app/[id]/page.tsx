      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center animate-fade-in-up">
          <h1 className="text-2xl font-bold mb-4">
            {t("table_not_found_title")}
          </h1>{" "}
          {/* "Stol topilmadi" */}
          <p className="text-gray-600 mb-4">
            {t("invalid_table_id_description")}
          </p>{" "}
          {/* "Kiritilgan stol ID si noto'g'ri yoki mavjud emas" */}
          <Button onClick={() => router.push("/")}>
            {t("back_to_homepage_button")}
          </Button>{" "}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8 animate-fade-in-up">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {t("welcome_to_amur_restaurant")}
            </h1>{" "}
            {/* "Amur Restoraniga xush kelibsiz!" */}
            <p className="text-gray-600">
              {t("your_selected_table_info")}
            </p>{" "}
            {/* "Siz tanlagan stol ma'lumotlari" */}
          </div>
